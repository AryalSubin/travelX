...
function ParallaxTestimonial({ testimonialRef }: any) {
  return (
    <div
      ref={testimonialRef}
      className="min-h-screen bg-white  flex  flex-col justify-center items-center w-full   overflow-hidden "
    >
      <div className=" z-50 w-full pt-32 sm:pt-16 px-4 sm:px-16 bg-white">
      ...
      {/* vertical  */}
      <div className=" bg-white z-50 overflow-hidden   relative">
        <div className="w-[100vw] bg-white h-full max-[400px]:px-0 px-8">
          <div className="flex bg-white z-50 sm:px-16 px-4 overflow-hidden  justify-center relative gap-32   h-[60vh]  sm:h-[90vh]  pb-24  ">
            <div className="absolute h-full sm:w-[5%] w-[2%] max-[400px]:w-0  top-0 left-0  bg-gradient-to-r from-[#fff] via-[#fff] to-transparent   z-20"></div>
            <div className="absolute h-full sm:w-[5%] w-[2%] max-[400px]:w-0  top-0 right-0  bg-gradient-to-r from-transparent via-[#fff]  to-[#fff]   z-20"></div>
            <div className="absolute w-full h-[30%]  top-0 left-0  bg-gradient-to-b from-[#fff] via-[#fff] to-transparent   z-20"></div>
            <div className="absolute w-full h-[30%]   bottom-0 right-0 bg-gradient-to-b from-transparent via-[#fff] to-[#fff] z-20"></div>
            <div className="whole-div sm:rotate-45  max-sm:hidden   relative flex flex-col   flex-nowrap   ">
              {[1, 2, 3].map((item) => {
                return (
                  <motion.div
                    key={item}
                  ...
                  >
                    {reviewData.map((item) => {
                      return (
                        <div
                          key={item.id}
                          className="flex flex-col  min-w-[270px] max-w-full h-fit  "
                        >
            ...
            <div className="whole-div rotate-45 max-xl:hidden relative flex flex-col   flex-nowrap  ">
              {[1, 2, 3, 4, 5].map((item) => {
                return (
                  <motion.div
                    key={item}
            ...
            <div className="whole-div  sm:rotate-45 relative flex flex-col   flex-nowrap  ">
              {[1, 2, 3].map((item) => {
                return (
                  <motion.div
                    key={item}
            ...
            <div className="whole-div rotate-45 max-lg:hidden relative flex flex-col   flex-nowrap   ">
              {[1, 2, 3].map((item) => {
                return (
                  <motion.div
                    key={item}
                      ...
                      return (
                        ...
                        >
                          <div className="four w-full flex flex-col gap-4 justify-between p-4 bg-[#f1f1f1]  border border-gray-200 rounded-2xl h-full">
                            ...
                            <div>
                              <div className="flex  gap-2 px-2 ">
                                <div className="size-12 bg-white  border-2 border-gray-300  rounded-full overflow-hidden"></div>
                                <div className="flex flex-col justify-center gap-1 text-sm text-gray-500 font-semibold ">
                                  <p className="text-base capitalize">
                                    {item.name}
                                  </p>
